...
const teamMembers = [
  {
    ...
    image: "https://media.licdn.com/dms/image/v2/C4D03AQGvJxzwIUoptg/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1608040081250?e=1753920000&v=beta&t=qM0_T0RFBGk3gH2gzWg0Dacs_lkkyryGhPq9K6kkEX8",
  },
  {
    id: 2,
    name: "Idrissi Dina",
    designation: "chargée de recrutement et superviseuse RH",
    image: "https://media.licdn.com/dms/image/v2/D4E03AQFKHcxGMWj7hA/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1676472484239?e=1753920000&v=beta&t=sJ7Ei8UfCQhE0xj_vnBz511cl1mczn_8VQQEV1LfN50",
  },
 
  {
    ...
    image: "https://media.licdn.com/dms/image/v2/C4D03AQGvjo-UaKFo2g/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1635345292563?e=1753920000&v=beta&t=rWSzL1bBFB2sNV3h4hs1XsHQaorpSIASzYrAhoCKGks",
  },
...
const testimonials = [
  {
    quote:
      "JobOP transformed how we hire talent. The quality of matches is incredible and saved us months of recruitment time. The AI-powered system really understands what we're looking for.",
    name: "Jennifer Adams",
  ...
  {
    quote:
      "As a freelancer, this platform connected me with amazing opportunities. The loan feature helped me invest in new skills and grow my career exponentially.",
    name: "Marcus Johnson",
  ...
  {
    quote:
      "The AI-powered matching is spot on. We found our perfect team members within days, not weeks. The quality of candidates is consistently high.",
    name: "Rachel Kim",
  ...
  {
    quote:
      "Professional, efficient, and results-driven. JobOP is the future of talent acquisition. The platform's interface is intuitive and powerful.",
    name: "David Chen",
  ...
  {
    quote:
      "The platform's rating system ensures we only work with top-quality professionals. Highly recommended for any serious business looking for talent!",
  ...
  {
    quote:
      "Outstanding support and seamless experience. The team behind JobOP really cares about connecting the right people with the right opportunities.",
    name: "Alex Thompson",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                >
                  Connect with <Highlight className="text-black dark:text-white">Top Talent</Highlight> Instantly
                </motion.h1>
                ...
                >
                  Our AI-powered platform matches companies with verified professionals based on skills, ratings, and
                  experience. Build your dream team in minutes, not months.
                </motion.p>
              </div>
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">Instant Matching</span>
                </div>
              </motion.div>
            </motion.div>
              ...
              <div className="relative mx-3">
                ...
                >
                  ...
                  <div className="relative z-10 space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="text-lg font-semibold dark:text-white">Top Matches</h3>
                      ...
                      {[1, 2, 3].map((i) => (
                        ...
                        >
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            <span className="text-sm font-medium dark:text-white">4.{9 - i}</span>
                          </div>
                        </motion.div>
                      ))}
                    </div>
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-lg font-bold dark:text-white">50K+</div>
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-lg font-bold dark:text-white">98%</div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900" id="features">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-4xl font-bold mb-4 dark:text-white">Why Choose JobOP?</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Discover the powerful features that make talent matching effortless and effective.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                features: ["Smart skill assessment", "Performance analytics", "Verified reviews"],
              ...
              },
              {
                ...
                description: "Comprehensive analytics and live activity tracking for better decision making",
                features: ["Live activity feeds", "Performance metrics", "Project insights"],
              ...
              },
              {
                ...
                description: "Loan services and financial tools to help professionals grow their careers",
                features: ["Quick loan approval", "Competitive rates", "Flexible terms"],
                ...
                <Card className="h-full hover:shadow-2xl transition-all duration-300 border-0 bg-white dark:bg-gray-800 overflow-hidden">
                  <CardHeader className="relative">
                    ...
                    <div className="relative z-10">
                      ...
                      <CardDescription className="dark:text-gray-300 text-base">{feature.description}</CardDescription>
                    </div>
                  </CardHeader>
